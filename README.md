...
DarkFly now is: <a href="https://github.com/Anonymous3-SIT/DarkFly">DarkFly-2020.1</a> (generation of DarkFly-tool) Try it.
...
* `pkg install python2`
* `pkg install git`
* `git clone https://github.com/Anonymous3-SIT/DarkFly`
* `cd DarkFly`
* `python2 install.py`
